    ...
    <div className="bg-black min-h-screen">
      <div className="relative min-h-screen">
        ...
        <main className="relative z-10 min-h-screen flex flex-col items-center justify-center text-white text-center px-4">
         <div className="absolute flex flex-col items-start" style={{bottom: "80px" , left:"65px"}}>
          ...
          <button className="bg-transparent border border-white rounded-full text-white font-bold py-3 px-8 text-sm hover:bg-white hover:text-black transition-colors duration-300"  onClick={() => (window.location.href = "/product")}>
            {t("explore_button")}
          </button>
         </div>
        </main>
